                                ...
                                <div class="col-lg-4" @if($ocultarCampos) hidden @endif>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" id="status" required @if($ocultarCampos) hidden @endif>
                                            <option {{ $sale_return->status == 'Completado' ? 'selected' : '' }} value="Completado" @if($ocultarCampos) selected @endif >Completado</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4" @if($ocultarCampos) hidden @endif>
                                    <div class="from-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="payment_method" required value="{{ $sale_return->payment_method }}" readonly @if($ocultarCampos) hidden @endif>
                                        </div>
                                    </div>
                                </div>
