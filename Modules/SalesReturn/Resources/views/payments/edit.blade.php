...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item"><a href="{{ route('sale-returns.index') }}">Devoluciones de Ventas</a></li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="due_amount">Monto Pendiente <span class="text-danger">*</span></label>
                                    ...
                                    <div class="from-group">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="payment_method" id="payment_method" required>
                                                ...
                                                <option {{ $saleReturnPayment->payment_method == 'Otro' ? 'selected' : '' }} value="Otro">Otro</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
