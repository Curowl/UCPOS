    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <p class="font-italic">Cambia tu información de perfil y contraseña desde aquí...</p>
            </div>
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('profile.update') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <img style="width: 100px;height: 100px;" class="d-block mx-auto img-thumbnail img-fluid rounded-circle mb-2" src="{{ auth()->user()->getFirstMediaUrl('avatars') }}" alt="Imagen de Perfil">
