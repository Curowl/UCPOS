        ...
        <div class="card-body">
                ...
                <table class="table table-bordered mb-0">
                    ...
                    <tr class="align-middle">
                        ...
                        <th class="align-middle">
                            Cantidad <i class="bi bi-question-circle-fill text-info" data-toggle="tooltip" data-placement="top" title="Cantidad Máxima: 100"></i>
                        </th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        ...
                        @else
                            <td colspan="3" class="text-center">
                                <span class="text-danger">Por favor busca y selecciona el producto</span>
                            </td>
                        @endif
                    </tr>
                    </tbody>
            ...
            <div class="mt-3">
                <button wire:click="generateBarcodes({{ $product }}, {{ $quantity }})" type="button" class="btn btn-primary">
                    <i class="bi bi-upc-scan"></i> Generar código de barras
                </button>
            </div>
        </div>
    </div>
