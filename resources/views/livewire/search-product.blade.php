        ...
        <div class="card-body">
            <div class="form-group mb-0">
                <div class="input-group">
                    ...
                    <input wire:keydown.escape="resetQuery" wire:model.live.debounce.500ms="query" type="text" class="form-control" placeholder="Escribe el código o el nombre del producto....">
                </div>
            </div>
        </div>
    </div>
