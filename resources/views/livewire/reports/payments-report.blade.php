                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select wire:model.live="payments" class="form-control" name="payments">
                                        <option value="">Seleccionar Pagos</option>
                                        <option value="sale">Ventas</option>
                                        <option value="sale_return">Devoluciones de Ventas</option>
                                        <option value="purchase">Compras</option>
                                        <option value="purchase_return">Devoluciones de Compras</option>
                                    </select>
                                    @error('payments')
                                    <span class="text-danger mt-1">{{ $message }}</span>
                                    @enderror
